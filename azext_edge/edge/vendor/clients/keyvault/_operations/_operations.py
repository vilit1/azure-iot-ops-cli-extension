...
def build_key_vault_set_secret_request(secret_name: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "7.4"))
...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):
    ...
    @distributed_trace
    def set_secret(
        self, vault_base_url: str, secret_name: str, parameters: Union[JSON, IO[bytes]], **kwargs: Any
    ) -> JSON:
        """Sets a secret in a specified key vault.
        ...
        :param secret_name: The name of the secret. The value you provide may be copied globally for
         ...
         identifiable or sensitive information. Required.
        :type secret_name: str
        :param parameters: The parameters for setting the secret. Is either a JSON type or a IO[bytes]
         type. Required.
    ...
    def update_secret(
        ...
        secret_name: str,
        secret_version: str,
        parameters: Union[JSON, IO[bytes]],
        **kwargs: Any
    ) -> JSON:
        """Updates the attributes associated with a specified secret in a given key vault.
        ...
        :param secret_version: The version of the secret. Required.
        :type secret_version: str
        :param parameters: The parameters for update secret operation. Is either a JSON type or a
    ...
    @distributed_trace
    def restore_secret(self, vault_base_url: str, parameters: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        """Restores a backed up secret to a vault.
        ...
        :param vault_base_url: The vault name, for example https://myvault.vault.azure.net. Required.
        :type vault_base_url: str
        :param parameters: The parameters to restore the secret. Is either a JSON type or a IO[bytes]
         type. Required.
        :type parameters: JSON or IO[bytes]
        :return: JSON object
        :rtype: JSON
