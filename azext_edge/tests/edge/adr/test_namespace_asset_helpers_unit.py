...
@pytest.mark.parametrize("test_case", [
    ...
    # Test case 3: Move some children successfully
    {
        "asset_properties": {
            "parentKey": [
                {"name": "dataset1", "childKey": [
    ...
    # Test case 4: Move children with replace
    {
        "asset_properties": {
            "parentKey": [
                {"name": "dataset1", "childKey": [
